...
🧭 **HDLC (High-Level Data Link Control)** 는 ISO(국제표준화기구)에서 제정한 데이터 링크 계층의 비트 지향 통신 프로토콜이에요. 주로 동기식 통신 환경에서 사용되며, 데이터의 신뢰성 있는 전송을 위해 프레이밍, 오류 제어, 흐름 제어 기능을 제공합니다. <br/>
